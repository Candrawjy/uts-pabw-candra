	<main>
		...
		<?php $kategori = $this->db->select(array('jenis_kategori.*, produk.*'))->distinct()->from("jenis_kategori")->join('produk', 'produk.id_jeniskategori = jenis_kategori.id_jeniskategori')->group_by('jenis_kategori.id_jeniskategori')->where('jenis_kategori.target', 'UMKM')->where('produk.id_umkm_jasa', $umkm_jasa['id_umkm_jasa'])->get()->result();?>
		                ...
		                <div class="box_order mobile_fixed">
		                    ...
		                    <div class="main">
		                        ...
		                        <div class="btn_1_mobile">
		                            <a href="http://wa.me/<?=$umkm_jasa['nohp_umkmjasa']?>?text=Halo,%20<?=$umkm_jasa['nama_umkmjasa']?>" class="btn_1 gradient full-width mb_5" target="_blank">Hubungi UMKM</a>
		                        </div>
		                    </div>
		                </div>
		                <div class="btn_reserve_fixed"><a href="javascript:void(0)" class="btn_1 gradient full-width">Detail UMKM</a></div>
		            </div>
		        </div>
		    </div>
		</div>
